# Optomotrist — Faust/JUCE audio plugin
# Run `just` or `just --list` to see available recipes.

build_type := "Debug"
build_dir := "build"
dsp_source := "dsp/optomotrist.dsp"
...
run *flags:
    ...
    open {{build_dir}}/Optomotrist_artefacts/{{build_type}}/Standalone/Optomotrist.app
