...
public:
  void editorShown(juce::TextEditor *editor) override {
    ...
    editor->setColour(juce::TextEditor::outlineColourId, juce::Colour(OptomotristColors::panelBorder));
...
void PluginLookAndFeel::drawRotarySlider(juce::Graphics &g,
  ...
  const auto meterPos = OptomotristColors::peakToMeterNormalised(meterPeak);
  ...
  if (showMeter) {
    ...
    if (meterPos > 0.0f) {
      ...
      meterArc.addCentredArc(centreX,
                             ...
                             meterAngle,
                             true);
      g.setColour(OptomotristColors::meterColourForPeak(meterPeak));
...
juce::Label *PluginLookAndFeel::createSliderTextBox(juce::Slider &slider) {
  ...
  label->setColour(juce::Label::textColourId, juce::Colour(OptomotristColors::valueText));
  label->setColour(juce::Label::backgroundColourId, juce::Colours::transparentBlack);
  label->setColour(juce::Label::outlineColourId, juce::Colours::transparentBlack);
  label->setColour(juce::TextEditor::backgroundColourId, juce::Colour(0xff222020));
  label->setColour(juce::TextEditor::outlineColourId, juce::Colour(OptomotristColors::panelBorder));
  ...
  label->setColour(juce::TextEditor::highlightedTextColourId,
                   juce::Colour(OptomotristColors::valueText));
  label->setColour(juce::TextEditor::textColourId, juce::Colour(OptomotristColors::valueText));
...
void PluginLookAndFeel::drawButtonText(juce::Graphics &g,
  ...
  auto textColour =
      isOn ? juce::Colour(OptomotristColors::accentBright) : juce::Colour(OptomotristColors::labelText);
