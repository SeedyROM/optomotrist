...
const juce::String OptomotristAudioProcessor::getName() const {
...
const juce::String OptomotristAudioProcessor::getProgramName(int index) {
  juce::ignoreUnused(index);
  return {};
}
...
juce::ValueTree OptomotristAudioProcessor::captureCurrentState() {
...
void OptomotristAudioProcessor::initialiseABSlotsFromCurrentState() {
...
void OptomotristAudioProcessor::syncActiveABSlotFromCurrentState() {
...
juce::ValueTree &OptomotristAudioProcessor::getMutableABState(ABSlot slot) {
...
void OptomotristAudioProcessor::setActiveABSlot(ABSlot slot) {
...
void OptomotristAudioProcessor::copyABSlot(ABSlot from, ABSlot to) {
  syncActiveABSlotFromCurrentState();
...
void OptomotristAudioProcessor::swapABSlots() {
  syncActiveABSlotFromCurrentState();
...
bool OptomotristAudioProcessor::hasDistinctABState() const {
  return !slotAState.isEquivalentTo(slotBState);
}

juce::String OptomotristAudioProcessor::getActivePresetName() const {
  return activeABSlot == ABSlot::A ? slotAPresetName : slotBPresetName;
}

juce::String OptomotristAudioProcessor::getDisplayedPresetName() {
  syncActiveABSlotFromCurrentState();
...
bool OptomotristAudioProcessor::isActivePresetFactory() const {
...
bool OptomotristAudioProcessor::saveUserPreset(const juce::String &presetName) {
  syncActiveABSlotFromCurrentState();
...
void OptomotristAudioProcessor::revealPresetDirectory() const {
  PluginPresetManager::revealPresetDirectory();
}

void OptomotristAudioProcessor::clearABState() {
  syncActiveABSlotFromCurrentState();
...
juce::AudioProcessor *JUCE_CALLTYPE createPluginFilter() {
  return new OptomotristAudioProcessor();
}
