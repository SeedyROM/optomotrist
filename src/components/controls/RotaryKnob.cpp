...
RotaryKnob::RotaryKnob(juce::AudioProcessorValueTreeState &apvts,
  ...
  slider.setColour(juce::Slider::textBoxTextColourId, juce::Colour(OptomotristColors::valueText));
  ...
  label.setColour(juce::Label::textColourId, juce::Colour(OptomotristColors::labelText));
  ...
  if (valueLabel != nullptr) {
    ...
    valueLabel->setColour(juce::Label::textColourId,
                          useActiveMeterColour
                               ? OptomotristColors::meterColourForPeak(meterPeak)
