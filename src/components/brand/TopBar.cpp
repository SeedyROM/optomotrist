...
void TopBar::paint(juce::Graphics &g) {
  ...
  juce::ColourGradient bg(juce::Colour(OptomotristColors::topBarBg),
                          0.0f,
                          0.0f,
                          juce::Colour(OptomotristColors::background),
                          bounds.getWidth(),
                          0.0f,
                          false);
  ...
  g.setColour(juce::Colour(OptomotristColors::accentWarm).withAlpha(0.4f));
